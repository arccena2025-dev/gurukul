...
VALUES (1,
'"Gurukul Public School " has been startedby the Savitribai Phule Mahila Shikshan Prasarak Mandal. It was started in June 2019. Since Oct. 2023 the school is affiliated with CBSE.\n\nOur school education aims at making children capable of becoming responsible, productive and useful members of society. Knowledge, skill and attitudes are built through learning experiences and opportunities created for learners in school.\n\nIn this modern world of western culture, GPS tries to maintain the Indian culture of \'Gurukul\' system. Our school simultaneously reflects the current needs and aspirations of society.\n\nOur children learn through variety of ways and experiences, experimentations, reading, discussion, asking, listening, thinking, reflecting and expressing oneself in speech or writing both individually and with others.',
'Beyond textbooks, our school embraces the National Education Policy, fostering holistic growth. Imagine a garden where not only academic flowers bloom but also the petals of co-curricular activities flourish. From science labs to art studios, every corner echoes with the joy of exploration.\n\nIn this dynamic ecosystem, assessments become stepping stones, not stumbling blocks. The emphasis is on understanding, not just memorization. Our school moulds students into critical thinkers, ready to face the challenges of a changing world.\n\nAs the final bell rings, it\'s not just the end of a school day; it\'s a pause in a lifelong journey of discovery. Our students, armed with the wisdom to step out into the world, ready to write their own stories',
...
('2019', 'The Foundation & Commencement', 'Gurukul Public School was established in June 2019 by the Savitribai Phule Mahila Shikshan Prasarak Mandal.', 1),
('2023', 'CBSE Affiliation Milestone', 'Since October 2023, the school is officially affiliated with CBSE, raising the benchmark of academic excellence.', 2),
('2026', 'Future-Ready Excellence', 'Fully embracing the National Education Policy (NEP) with elite science labs, art studios, and holistic assessments.', 3);
...
('Mr. Akhilesh Dhakane', 'Executive Director, Gurukul Group Of Schools, Beed', 'Our focus is to synthesize standard pedagogical rigor with modern technological skills and outdoor learning, empowering students for the future.', 'Executive Director of Gurukul Group Of Schools, Beed. Orchestrating curriculum innovations, athletic expansions, and technological progress across all campuses.', NULL, 1),
('Dr.Mrs. Vineeta R.Dhakane', 'President', 'Welcome to Gurukul Academy. Our mission is to cultivate scholastic brilliance alongside high moral principles, preparing students for impactful global citizenship.', 'President of Gurukul Academy, steering the institution\'s strategic vision, educational policies, and excellence standards.', NULL, 2),
('Dr.Mr. Rajendra N. Dhakane', 'Secretary', 'At Gurukul, we prioritize conceptual learning, analytical independence, and social responsibility to transform young minds into ethical leaders.', 'Secretary of Gurukul Academy, overseeing administrative execution, regulatory compliances, and academic operations.', NULL, 3),
